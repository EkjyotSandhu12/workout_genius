...
class AddExercuseUiNew extends StatefulWidget {
  const AddExercuseUiNew({
    super.key,
  });

  @override
  State<AddExercuseUiNew> createState() => _AddExercuseUiNewState();
}

class _AddExercuseUiNewState extends State<AddExercuseUiNew> {
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Text(AppStrings.addExercise, style: TextStyles().getRubikTextStyle(fontSize: 20),),
              const Divider(),
              const SizedBox(
                height: 12,
              ),
